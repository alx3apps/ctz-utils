...
import ru.concerteza.util.collection.maps.LowerKeysIgnoreNullImmutableMapBuilder;
...
public class LowerColumnsIgnoreNullMapper implements RowMapper<Map<String, ?>> {
    public Map<String, ?> mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        ImmutableMap.Builder<String, Object> builder = LowerKeysIgnoreNullImmutableMapBuilder.builder();
